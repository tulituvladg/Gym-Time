...
public class optimizedCountdown extends AppCompatActivity {
    Button startButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_optimized_countdown);
        startButton = (Button) findViewById(R.id.startButtonO);
        secondsLeft = (TextView) findViewById(R.id.secondsLeftO);
        secondsLeftText = (TextView) findViewById(R.id.secondsLeftTextO);
